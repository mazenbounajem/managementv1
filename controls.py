...
class ControlsClass():
    def controls(first_frame,root,add,save,duplicate,undo,delete,print,refresh,search):    
        ...
        root.duplicateimg = icon_duplicate
